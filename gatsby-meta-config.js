module.exports = {
  ...
  about: {
    introduce: [
      '화면을 구현하는 일에서 시작했지만 지금은 무엇을 풀 것인지 정하는 단계부터 참여합니다. 문제를 정의하고 필요한 제품을 빠르게 배포한 뒤 데이터로 다음 결정을 검증합니다. 출시한 뒤 실제로 나아졌는지 확인하는 일까지 함께 하고 있습니다.',
    ...
    timestamps: [
      ...
      // ========================================================
      {
        ...
        jobDescriptions: [
          ...
          '데이터로 검증한 전환 개선과 점진 이관: 문의 폼을 단일 스텝에서 멀티스텝으로 바꾸는 안을 A/B 테스트로 검증했습니다. 전환율이 16.7% 개선되는 것을 확인한 뒤 적용했습니다. 지금은 최종 개인정보 입력 단계의 이탈 원인을 다음 검증 과제로 두고 있습니다. Google Analytics·PostHog·Search Console·메타픽셀 계측을 직접 구축했습니다. 운영을 멈추지 않고 Next.js 12에서 14로, JavaScript에서 TypeScript로, Fetch에서 TanStack Query로 기능 단위 이관을 진행했습니다.',
